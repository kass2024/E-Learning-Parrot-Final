      ...
      <section className="public-page-offset pb-20 px-4 bg-gradient-to-b from-blue-50 via-white to-white border-b border-slate-200">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center max-w-6xl mx-auto">
            <div>
              <Badge className="mb-4 bg-[#E01C21]/20 text-[#0A0A0A] border border-[#E01C21]/40">
                About us
              </Badge>
              <h1 className="text-4xl md:text-5xl font-bold mb-4 text-slate-900">
                About parrotglobalstudyacademy
              </h1>
              ...
              <p className="text-sm md:text-base text-slate-700 max-w-xl">
                parrotglobalstudyacademy offers structured online programs, clear explanations, and practical tools for learners who
            ...
            <div className="relative">
              <div
                className="absolute -inset-6 bg-gradient-to-tr from-[#E01C21]/25 via-sky-400/15 to-blue-400/15 blur-3xl"
                aria-hidden="true"
              />
      ...
      <section className="py-20 px-4 bg-white">
        <div className="container mx-auto max-w-6xl">
          <div className="grid gap-8 md:grid-cols-2">
            <Card className="border border-[#38761D]/15 bg-white shadow-sm hover:shadow-lg hover:border-[#E01C21]/60 transition-all rounded-2xl">
              <CardHeader>
