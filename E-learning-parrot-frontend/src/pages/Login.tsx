  ...
  const inputClass = (opts?: { error?: boolean; success?: boolean }) =>
    cn(
      ...
      isInstitutionLocked
        ...
        : "focus-visible:ring-[#38761D]/20 focus-visible:border-[#38761D]",
      ...
      <div className="space-y-1.5">
        <div className="flex items-center justify-between">
          ...
          {!isInstitutionLocked && (
            <NavLink
              to="/forgot-password"
              className="text-xs font-semibold text-[#38761D] hover:text-[#E01C21] transition-colors"
            >
              Forgot password?
            </NavLink>
          )}
        ...
        <div className="relative">
          ...
          <button
            type="button"
            className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-[#38761D] transition-colors"
        ...
        <Checkbox
          ...
          className={
            isInstitutionLocked
              ...
              : "data-[state=checked]:bg-[#38761D] data-[state=checked]:border-[#38761D]"
          }
        />
      ...
      <Button
        ...
        className={
          isInstitutionLocked
            ...
            : "w-full rounded-md bg-[#38761D] hover:bg-[#2A5F17] text-white font-bold h-12 text-base"
        }
      >
        {loading ? (
        ...
        >
          ...
          <div className="rounded-2xl overflow-hidden shadow-2xl bg-white border border-slate-200">
            <div className="grid md:grid-cols-2">
              ...
              <div className="bg-gradient-to-br from-[#38761D] to-[#2A5F17] p-8 md:p-10 text-white flex flex-col justify-center">
                  ...
                  {PERKS.map((text) => (
                    <li key={text} className="flex items-start gap-3 text-sm text-white/90">
                      <span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-white/15">
                        <CheckCircle2 className="h-3.5 w-3.5 text-[#E01C21]" />
                      </span>
                      {text}
                    </li>
                  ))}
              ...
              <div className="p-8 md:p-10">
                <div className="mb-6">
                  <h2 className="text-xl font-bold text-[#38761D]">Log In</h2>
                ...
                <div className="mt-8 pt-6 border-t border-slate-100 text-center">
                  ...
                  <NavLink
                    to="/signup"
                    className="inline-flex items-center gap-1.5 text-sm font-semibold text-[#38761D] hover:text-[#E01C21] transition-colors group"
                  >
                    Sign Up
