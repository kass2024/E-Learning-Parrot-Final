      ...
      <div className="container max-w-2xl mx-auto py-12 px-4">
        ...
        {loading ? (
          ...
          <Card className="border-emerald-200 shadow-lg overflow-hidden">
            <div className="bg-gradient-to-r from-[#38761D] to-[#1D3B66] px-6 py-8 text-center text-white">
              ...
              <CardDescription className="text-white/80 mt-1">
                This is an authentic parrotglobalstudyacademy completion certificate.
              </CardDescription>
            </div>
