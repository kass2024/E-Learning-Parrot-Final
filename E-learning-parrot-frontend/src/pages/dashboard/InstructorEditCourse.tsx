...
const TAB_CLASS =
  "data-[state=active]:bg-[#38761D] data-[state=active]:text-white rounded-lg text-sm";
  ...
  if (loading) {
    return (
      <div className="flex justify-center py-20">
        <Loader2 className="h-10 w-10 animate-spin text-[#38761D]" />
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6 pb-10 max-w-4xl">
      ...
      <Card className="overflow-hidden border-0 shadow-lg ring-1 ring-[#38761D]/10">
        ...
        <CardHeader className="border-b border-[#38761D]/10 bg-[#38761D]/[0.03] pb-4">
        ...
        <CardContent className="p-5 sm:p-6">
          <form onSubmit={handleSubmit}>
            <Tabs defaultValue="basics" className="space-y-5">
              ...
              <TabsContent value="basics" className="space-y-4 mt-0">
                <div className="space-y-1.5">
                  ...
                  <select
                    id="program"
                    className="flex h-11 w-full rounded-md border border-[#38761D]/15 bg-background px-3 text-sm"
                    value={programId ?? ""}
                ...
                <div className="space-y-1.5">
                  ...
                  <Input
                    id="title"
                    className="h-11 border-[#38761D]/15"
                    value={title}
                ...
                <div className="space-y-1.5">
                  ...
                  <Textarea
                    ...
                    rows={2}
                    className="border-[#38761D]/15 resize-none"
                  />
                </div>
            ...
            <div className="mt-8 flex flex-col-reverse gap-2 border-t border-[#38761D]/10 pt-6 sm:flex-row sm:justify-between">
              <Button type="button" variant="ghost" onClick={() => navigate("/dashboard/my-courses")}>
                <ArrowLeft className="mr-2 h-4 w-4" />
                Back
              </Button>
              <Button type="submit" disabled={saving} className="bg-[#38761D] hover:bg-[#38761D] h-11 px-6">
