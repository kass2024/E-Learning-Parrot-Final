  ...
  const invitationsBlock = (
    <div className={cn(
      ...
      isWebinar
        ...
        : "rounded-xl border border-[#38761D]/10 bg-slate-50/60 p-4",
    )}>
      <div className="flex items-center gap-2">
        <Users className={cn("h-4 w-4", isWebinar ? "text-teal-800" : "text-[#38761D]")} />
        <p className={cn("text-sm font-semibold", isWebinar ? "text-teal-900" : "text-[#38761D]")}>
                  ...
                  className={cn(
                    ...
                    selected
                      ? isWebinar
                        ...
                        : "bg-[#38761D]/10 border border-[#38761D]/20"
                      : "hover:bg-slate-50",
                  )}
                >
                  <span
                    className={cn(
                      ...
                      selected
                        ? isWebinar
                          ...
                          : "bg-[#38761D] border-[#38761D] text-white"
                        : "border-slate-300",
                    )}
                  >
                    {selected ? "✓" : ""}
              ...
              <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
                <div className="min-w-0">
                  <div className="flex items-center gap-2 flex-wrap mb-1">
                    ...
                    <h3 className={cn("font-semibold truncate", isWebinar ? "text-teal-950" : "text-[#38761D]")}>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-5 gap-6 items-start">
        <Card className="xl:col-span-2 border-[#38761D]/10 shadow-sm">
          <CardHeader className="pb-4">
            <CardTitle className="flex items-center gap-2 text-[#38761D]">
          ...
          <CardContent>
            <form className="space-y-6" onSubmit={handleCreateMeeting}>
              ...
              <Button
                type="submit"
                disabled={creating}
                className="w-full h-11 bg-[#38761D] hover:bg-[#2A5F17] font-semibold"
              >
                {creating ? (
                  <>
                    <Loader2 className="mr-2 h-4 w-4 animate-spin" />
        ...
        <Card className="xl:col-span-3 border-[#38761D]/10 shadow-sm">
          <CardHeader className="pb-4">
            <CardTitle className="flex items-center gap-2 text-[#38761D]">
