  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        <Card className="ring-1 ring-[#38761D]/10 border-0 shadow-md">
          <CardHeader className="flex flex-row items-center justify-between">
            <div>
              <CardTitle className="text-[#38761D]">Your courses</CardTitle>
          ...
          <CardContent className="space-y-3">
            {(data?.courses ?? []).length === 0 ? (
              <p className="text-sm text-muted-foreground">
                ...
                <button
                  type="button"
                  className="text-[#38761D] underline font-medium"
                  onClick={() => navigate("/dashboard/instructor/create-course")}
                >
                  Create one
                </button>
              ...
              (data?.courses ?? []).slice(0, 5).map((course) => (
                <div
                  key={course.id}
                  className="flex items-center justify-between gap-3 rounded-xl border border-[#38761D]/10 bg-gradient-to-r from-white to-[#38761D]/[0.03] p-3 dark:from-card"
                >
