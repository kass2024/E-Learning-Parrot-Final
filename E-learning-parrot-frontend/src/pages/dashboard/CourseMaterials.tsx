...
export default function CourseMaterials() {
  ...
  return (
    <div className="space-y-6 sm:space-y-8 p-4 sm:p-6">
      ...
      {/* Header */}
      <div className="rounded-2xl border border-border bg-gradient-to-r from-[#38761D] to-[#1D3B66] p-6 sm:p-8 shadow-strong">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex items-start gap-4">
            <ParrotLogo size="lg" showRing={false} className="ring-2 ring-white/30 hidden sm:flex" />
            <div>
            <p className="text-[11px] uppercase tracking-[0.25em] font-semibold text-white/80">parrotglobalstudyacademy</p>
