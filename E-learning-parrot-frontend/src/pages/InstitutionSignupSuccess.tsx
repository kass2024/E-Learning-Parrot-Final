  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      <main className="container max-w-lg public-page-offset pb-16 px-4">
        ...
        >
          <div className="bg-gradient-to-r from-[#38761D] to-[#2A5F17] px-6 py-8 text-center text-white">
            {done ? (
          ...
          <div className="p-6 space-y-4">
            ...
            {done && (
              <div className="rounded-xl bg-[#38761D]/5 border border-[#38761D]/15 p-4 flex gap-3 text-sm">
                <Mail className="h-5 w-5 text-[#38761D] shrink-0" />
                <p>Your login credentials were emailed when you registered. You can sign in once admin approves your institution.</p>
              </div>
            )}
            {done && (
              <Button className="w-full rounded-xl bg-[#38761D] hover:bg-[#2A5F17]" onClick={() => navigate("/login")}>
                Go to login
              </Button>
            )}
          </div>
