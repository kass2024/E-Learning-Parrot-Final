          ...
          <form onSubmit={handleSave}>
            <Tabs defaultValue="branding" className="space-y-4">
              ...
              <TabsContent value="branding" className="space-y-4">
                <InstitutionRegistrationLinkCard slug={slug} institutionName={name} compact className="rounded-xl border bg-[#38761D]/[0.03] p-4" />
                <div className="flex items-center gap-4 rounded-xl border bg-muted/30 p-4">
                  {logoUrl ? (
                    <img src={logoUrl} alt="" className="h-16 w-16 rounded-xl object-cover border shadow-sm" />
                  ) : (
                    <div className="flex h-16 w-16 items-center justify-center rounded-xl bg-[#38761D] text-white font-bold text-xl">
                ...
                <div className="rounded-xl border border-[#38761D]/15 bg-[#38761D]/[0.03] p-4 space-y-2">
                  <p className="text-sm font-medium text-[#38761D]">Meeting platform</p>
                ...
                {slug ? (
                  <p className="text-xs text-muted-foreground">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="font-medium text-[#38761D] underline-offset-2 hover:underline"
                    >
                      /i/{slug}
                    </a>
                  </p>
