  ...
  return (
    <div className="space-y-3">
          ...
          return (
            <button
              ...
              className={cn(
                ...
                active
                  ? "border-[#38761D] bg-[#38761D]/5 ring-2 ring-[#38761D]/20"
                  : "border-slate-200 bg-white hover:border-[#38761D]/30"
              )}
            >
              {active && (
                <span className="absolute top-2 right-2 flex h-5 w-5 items-center justify-center rounded-full bg-[#38761D] text-white">
                  <Check className="h-3 w-3" />
                </span>
              )}
              <div className="flex items-center gap-1.5 mb-1">
                <Icon className={cn("h-4 w-4", active ? "text-[#38761D]" : "text-slate-400")} />
                <span className="text-sm font-semibold text-slate-800">{preset.label}</span>
              </div>
              <span className={cn("text-xs font-medium", active ? "text-[#38761D]" : "text-slate-500")}>
        ...
        <div className="rounded-lg border border-slate-200 bg-slate-50/80 p-3 space-y-3">
          ...
          <div className="flex gap-2">
            <Button
              type="button"
              size="sm"
              className="bg-[#38761D] hover:bg-[#38761D]/90"
      ...
      {selectedCount === 0 ? (
        ...
        <p className="text-xs font-medium text-[#38761D]">
