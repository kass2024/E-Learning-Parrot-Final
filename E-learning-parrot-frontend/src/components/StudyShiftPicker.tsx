    ...
    <div className="space-y-3 rounded-xl border border-slate-200 bg-slate-50/50 p-3">
      ...
      <div>
        <p className="text-xs font-semibold text-slate-700 flex items-center gap-1.5">
          <CalendarDays className="h-3.5 w-3.5 text-[#38761D]" />
          ...
          return (
            <div
              ...
              className={cn(
                ...
                activeInGroup ? "border-[#38761D] shadow-sm ring-1 ring-[#38761D]/20" : "border-slate-200"
              )}
            >
                        ...
                        className={cn(
                          ...
                          selected
                            ...
                            : disabled
                              ...
                              : "border-slate-200 hover:border-[#38761D]/50 bg-white"
                        )}
                      >
