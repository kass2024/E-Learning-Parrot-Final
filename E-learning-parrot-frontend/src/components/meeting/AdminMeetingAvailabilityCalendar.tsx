  ...
  return (
    <div className="flex h-[min(780px,calc(100vh-12rem))] min-h-[560px] flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
      ...
      <div className="flex shrink-0 flex-wrap items-center gap-2 border-b border-slate-200 px-4 py-3">
        ...
        <h2 className="min-w-[140px] flex-1 text-lg font-semibold text-[#38761D]">{headerLabel}</h2>
      ...
      <div className="flex min-h-0 flex-1">
          ...
          {view === "week" ? (
            ...
            <div className="flex min-h-0 flex-1 flex-col overflow-auto p-4">
              <Calendar
                ...
                modifiersClassNames={{
                  available:
                    "font-semibold text-[#38761D] after:absolute after:bottom-1 after:left-1/2 after:h-1 after:w-1 after:-translate-x-1/2 after:rounded-full after:bg-emerald-500 after:content-['']",
                  exhausted:
                ...
                classNames={{
                  ...
                  caption_label: "text-base font-semibold text-[#38761D]",
                  head_cell: "text-slate-500 w-full font-medium text-xs uppercase",
                  row: "flex w-full mt-1",
                  cell: "relative aspect-square w-full p-0.5 text-center",
                  day: cn(
                    "h-full w-full rounded-lg font-medium hover:bg-[#38761D]/10",
                    "aria-selected:bg-[#38761D] aria-selected:text-white"
                  ),
                  day_today: "ring-2 ring-[#E01C21] ring-offset-1",
                  day_range_middle: "rounded-none bg-[#38761D]/15 text-[#38761D]",
                }}
              />
          ...
          <aside className="flex w-full shrink-0 flex-col border-l border-slate-200 bg-white sm:w-[340px] lg:w-[380px]">
            <div className="flex items-start justify-between border-b border-slate-100 px-4 py-3">
              <div className="min-w-0 pr-2">
                <p className="text-xs font-medium uppercase tracking-wide text-[#E01C21]">
                  {isCohort ? "Cohort session" : "Availability"}
                </p>
                <h3 className="truncate text-base font-semibold text-[#38761D]">{rangeSummary}</h3>
            ...
            <div className="flex-1 space-y-4 overflow-y-auto px-4 py-4">
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        recurrence === opt.value
                          ? "border-[#38761D] bg-[#38761D] text-white"
                          : "border-slate-200 text-slate-600 hover:border-[#38761D]/40"
                      )}
                    >
                      {opt.label}
                    </button>
              ...
              <div className="rounded-lg bg-[#38761D]/5 px-3 py-2 text-sm text-[#38761D]">
              ...
              {!isCohort && bookingsInRange.length > 0 && (
                <div className="rounded-lg border border-amber-200 bg-amber-50/50 p-3">
                  ...
                  <button
                    type="button"
                    className="mt-2 text-xs font-medium text-[#38761D] underline-offset-2 hover:underline"
            ...
            <div className="space-y-2 border-t border-slate-100 p-4">
              {(!isCohort ? !isBlocked : true) && (
                <div className="flex flex-col gap-2 sm:flex-row">
                  <Button
                    type="button"
                    className="flex-1 bg-[#38761D] hover:bg-[#38761D]/90"
        ...
        {!panelOpen && (
          <div className="hidden w-[280px] shrink-0 flex-col items-center justify-center border-l border-dashed border-slate-200 bg-slate-50/50 p-6 text-center lg:flex">
            <CalendarDays className="mb-3 h-10 w-10 text-[#38761D]/30" />
